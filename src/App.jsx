        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Gestión de Escuelas</h3>
              <p className="text-gray-600">Registro completo de escuelas rurales y sus docentes con información detallada y actualizable.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fichas de Estudiantes</h3>
              <p className="text-gray-600">Perfiles completos con datos personales, rendimiento académico, asistencia y seguimiento personalizado.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Actividades Escolares</h3>
              <p className="text-gray-600">Herramientas para que los docentes carguen y gestionen actividades, tareas y evaluaciones.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Informes automáticos de progreso por curso, escuela y región para todos los stakeholders.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Sincronización Offline</h3>
              <p className="text-gray-600">Funciona sin internet y sincroniza automáticamente cuando hay conectividad disponible.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Acceso Familiar</h3>
              <p className="text-gray-600">Portal web y móvil para que las familias puedan seguir el progreso de sus hijos.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-blue-100">Escuelas Rurales</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-blue-600 hover:bg-gray-100 font-bold py-3 px-8 rounded-lg text-lg transition duration-300">
              Solicitar Demo
            </button>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <div>
                  <label htmlFor="school" className="block text-sm font-medium text-gray-700 mb-1">Escuela/Institución</label>
                  <input type="text" id="school" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                </div>
                <div>
